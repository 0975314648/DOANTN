                                    ...
                                    <tr>
                                        <td><label><strong>Lớp</strong></label>
                                            <select class="form-control" style="border-radius:3px">
                                                @foreach($thongke as $p)
                                                <option name="malop" value="{{ $p->ma_lop }}-{{ $p->ma_khoahoc }}">{{ $p->ma_lop }} - {{ $p->ma_khoahoc }}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td style="padding:0px 30px 0px 30px"><label><strong>Môn học</strong></label>
                                            <select class="form-control" style="border-radius:3px">
                                                ...
                                                @foreach($thongke as $p)
                                                <option name="mamon" value="{{$p->tenmonhoc}}">{{$p->tenmonhoc}}</option>
                                                @endforeach
                                        ...
                                        <td style="padding:0px 30px 0px 0px"><label><strong>Loại</strong></label>
                                            <select class="form-control" style="border-radius:3px">
                                                @foreach($thongke as $p)
                                                <option name="loaihoc" value="{{ $p->ten_loaihoc }}">{{ $p->ten_loaihoc }}</option>
                                                @endforeach
                                            </select>
                                        </td>
