                                    ...
                                    <div class="table-responsive">                      
                                        <table class="table table-boxed table-bordered table-striped text-center">
                                            <thead>
                                                ...
                                                <?php $__currentLoopData = $masv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                	<td><?php echo e($key+1); ?></td>
                                                    <td><?php echo e($a->ma_sv); ?></td>
                                                    <td><?php echo e($a->hoten); ?></td>
                                                    <td><?php echo e($a->gioitinh); ?></td>
                                                    <td><?php echo e($a->ngaysinh); ?></td>
                                                
                                                <?php for($i=1;$i<=$sobuoi;$i++): ?>
                                                    <td><?php echo e($a->$i); ?></td>
                                                <?php endfor; ?>
                                                
                                                    <td>Tổng:<?php echo e($sobuoi); ?> <br>Vắng: 0<br>Muộn: 0</td>
                                                    <td>(trống)</td>
                                                    <td>Đạt</td>
                                                </tr>
