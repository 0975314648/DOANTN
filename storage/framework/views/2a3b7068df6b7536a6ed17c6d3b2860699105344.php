    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="nav-item"><a href="giangvien"> <i class="fas fa-home"></i> Trang chủ </a></li>
                ...
                <li class="nav-item"><a href="#"> <i class="fas fa-info-circle fa-fw fa-lg"></i> Giới thiệu</a></li>
                    ...
                    <ul class="dropdown-menu">                       
                        <li><a href="giangvien/lichday"> <i class="fas fa-fw fa-calendar"></i> Lịch dạy </a></li>
                        <li><a href="giangvien/diemdanh"> <i class="fas fa-fw fa-list-alt"></i> Dữ liệu điểm danh </a></li>
                        <li><a href="giangvien/thongke"> <i class="fas fa-fw fa-list-alt"></i> Thống kê điểm danh </a></li>
                    </ul>
                </li>
                                            </ul><!--//nav-->
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <p class="text-muted small">
                                                <?php echo e(Auth::user()->ma_user); ?></p>
...
</nav><!--//main-nav--><?php /**PATH D:\Program\Wamp\www\DOANTN\DOANTN-master\resources\views/layout_giangvien/menu.blade.php ENDPATH**/ ?>